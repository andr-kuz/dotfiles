...
map('t', '<M-x>', '<C-\\><C-n><C-w>c', { noremap = true, silent = true })
map('t', '<M-d>', '<Cmd>bd!', { noremap = true, silent = true })

map('i', '<M-h>', '<C-o><C-w>h', { noremap = true, silent = true })
map('i', '<M-j>', '<C-o><C-w>j', { noremap = true, silent = true })
map('i', '<M-k>', '<C-o><C-w>k', { noremap = true, silent = true })
map('i', '<M-l>', '<C-o><C-w>l', { noremap = true, silent = true })
map('i', '<M-x>', '<C-o><C-w>c', { noremap = true, silent = true })
...
map('n', '<M-x>', '<C-w>c', { noremap = true, silent = true })
