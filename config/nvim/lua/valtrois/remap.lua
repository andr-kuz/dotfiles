...
map('t', '<C-x>', '<C-\\><C-n><C-w>c', { noremap = true, silent = true })
map('t', '<C-d>', '<Cmd>bd!', { noremap = true, silent = true })

map('i', '<C-h>', '<C-o><C-w>h', { noremap = true, silent = true })
map('i', '<C-j>', '<C-o><C-w>j', { noremap = true, silent = true })
map('i', '<C-k>', '<C-o><C-w>k', { noremap = true, silent = true })
map('i', '<C-l>', '<C-o><C-w>l', { noremap = true, silent = true })
map('i', '<C-x>', '<C-o><C-w>c', { noremap = true, silent = true })
